...
const isLocalContainerHost = (): boolean => {
    ...
    const fetchInitialData = async () => {
      ...
      try {
        ...
        if (loadedData) {
          ...
          if (loadedData.backendUrl && !isLocalContainerHost()) {
            ...
            .on(
              ...
              (response: any) => {
                ...
                if (updates && typeof updates === "object") {
                  ...
                  if (updates.backendUrl !== undefined && !isLocalContainerHost()) {
    ...
    const refreshContentSilently = async () => {
      ...
      try {
        ...
        if (freshData) {
          ...
          if (d.backendUrl && !isLocalContainerHost()) {
