    ...
    const autoSyncSupabase = async () => {
      try {
        ...
        if (data.success && data.config) {
          ...
          let localSupaUrl = (safeLocalStorage.getItem("VITE_SUPABASE_URL") || "").trim();
          let localSupaKey = (safeLocalStorage.getItem("VITE_SUPABASE_ANON_KEY") || "").trim();
          
          // Clear old Supabase credentials if they mention the deleted project ref to prevent auto-backport leak
          if (localSupaUrl.includes("pzdkquvgqmarvqhoafgy")) {
            console.log("Old Supabase credentials detected in browser. Clearing...");
